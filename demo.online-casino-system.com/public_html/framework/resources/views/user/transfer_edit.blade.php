...
@section('content')
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/transfer/edit/' . $transfer->transfer_id) }}" id="transfer_edit_form" name="transfer_edit_form" data-url="{{ url('/') }}" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">

										@include('user.transfer_form', array('is_new'=>false) )
