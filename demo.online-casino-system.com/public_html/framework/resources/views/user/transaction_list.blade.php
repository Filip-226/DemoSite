...
@section('content')
							...
							<ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.transaction_manage_page') }}</li>
							</ol>

							<form class="form-horizontal" role="form" method="GET" action="{{ url('/panel/transaction/actions') }}" id="transaction_action_form" name="transaction_action_form" data-url="{{ url('/') }}" >
														...
														@foreach($transaction_list as $transaction)
															<tr> 
																...
																<td>
																	...
																	<a href="{{URL::to('/panel/transaction/edit/' . $transaction->transaction_id)}}">{{ Lang::get('general.edit_action') }}</a> | 
																	<a href="{{URL::to('/panel/transaction/delete/' . $transaction->transaction_id)}}" onclick="return confirm('{{ Lang::get('transaction.delete_msg') }}?');">{{ Lang::get('general.delete_action') }}</a>
																	@endif
																</td>
															</tr>
															<?php $i++; ?>
