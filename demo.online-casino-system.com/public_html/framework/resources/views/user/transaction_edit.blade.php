...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.transaction_edit_page') }}</li>
                            </ol>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/transaction/edit/' . $transaction->transaction_id) }}" id="transaction_edit_form" name="transaction_edit_form" data-url="{{ url('/') }}" enctype="multipart/form-data" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">

										@include('user.transaction_form', array('is_new'=>false) )
