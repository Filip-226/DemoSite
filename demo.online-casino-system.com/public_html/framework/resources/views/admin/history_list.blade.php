...
@section('content')
							...
							<form class="form-horizontal" role="form" method="GET" action="{{ url('/panel/admin/history/actions') }}" id="history_action_form" name="history_action_form" data-url="{{ url('/') }}" >
													...
													<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered">
														...
														@foreach($history_list as $history)
															<tr> 
																...
																<td>{{$history->casino_name}} ({{$history->casino_no}})</td>
