...
@section('content')
							...
							<ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.transfer_history_page') }}</li>
							</ol>

							<form class="form-horizontal" role="form" method="GET" action="{{ url('/panel/admin/transfer_history/actions') }}" id="transfer_history_action_form" name="transfer_history_action_form" data-url="{{ url('/') }}" >
											...
											<div class="panel panel-default">
													...
													<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered">
														<thead>
															<tr>
																...
																<th width="14%">{{ Lang::get('user.name_field') }}</th>
																<th width="14%">{{ Lang::get('transfer.from_field') }}</th>
																<th width="13%">{{ Lang::get('transfer.to_field') }}</th>
																<th width="6%">{{ Lang::get('transfer.amount_field') }}</th>
																<th width="7%">{{ Lang::get('transfer.status_field') }}</th>
																<th width="13%">{{ Lang::get('transfer.transaction_date_field') }}</th>
																<th width="13%">{{ Lang::get('transfer.verified_date_field') }}</th>
																<th width="18%">{{ Lang::get('transfer.action_field') }}</th>
															</tr>
														</thead>
														<tbody>
														<tr> 
														...
														<?php $i=1; ?>
														@foreach($transfer_list as $history)
															<tr> 
																<td>{{ $i }}</td>
																...
																<td>
																	<a href="{{URL::to('/panel/admin/history/view/' . $history->history_id)}}">{{ Lang::get('general.view_action') }}</a>
																</td>
															</tr>
															<?php $i++; ?>
														@endforeach
												...
												<div class="panel-footer">
													<div class="row">
														...
														<div class="col-sm-4">
															<input type="submit" class="btn btn-primary pull-left" value="Export" id="export_to_excel_btn" name="export_to_excel_btn" class="btn-success btn" />
														</div>
														<div class="col-sm-6">
