...
@section('content')
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ URL::route('panel.admin.user_inbox_compose', array($user_id)) }}" id="user_create_form" name="user_create_form" >
			...
			<div class="panel panel-default" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" class="required form-control" id="subject_txt" name="subject_txt" value="{{ old('subject_txt') }}" placeholder="{{ Lang::get('inbox.subject_field') }}" required>
						</div>
					</div>
