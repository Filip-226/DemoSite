...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.company_bankinfo_edit_page') }}</li>
                            </ol>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/admin/company/edit/' . $company_bank->company_id) }}" id="company_edit_form" name="company_edit_form" data-url="{{ url('/') }}" enctype="multipart/form-data" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">

										@include('admin.company_form', array('is_new'=>false) )
