...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.user_add_page') }}</li>
                            </ol>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/admin/user/add') }}" id="user_create_form" name="user_create_form" data-url="{{ url('/') }}" enctype="multipart/form-data" data-toggle="validator" role="form" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">
										
										@include('admin.user_form', array('is_new'=>true) )
