...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.casino_add_page') }}</li>
                            </ol>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/admin/casino/add') }}" id="casino_create_form" name="casino_create_form" data-url="{{ url('/') }}" enctype="multipart/form-data" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">
										
										@include('admin.casino_form', array('is_new'=>true) )
