...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li><a href="{{URL::route('panel.admin.transaction_manage')}}">{{ Lang::get('general.transaction_manage_page') }}</a></li>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/admin/transaction/verify/' . $transaction->transaction_id) }}" id="transaction_verify_form" name="transaction_verify_form" data-url="{{ url('/') }}" enctype="multipart/form-data" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">
										
										@include('admin.transaction_form')
