		...
		<div class="col-sm-12">
			<div class="panel panel-default" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">{{ Lang::get('transaction.status_field') }}</label>
						<div class="col-md-9">
							<input type="text" class="form-control" id="is_verified_txt" name="is_verified_txt" value="{{ ($history->is_verified == 1) ? 'Approved' : 'Rejected' }}" readonly>
						</div>
					</div>
