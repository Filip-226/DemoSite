...
@section('content')
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">{{ Lang::get('general.news_add_page') }}</li>
                            </ol>
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/panel/admin/news/add') }}" id="news_create_form" name="news_create_form" data-url="{{ url('/') }}" enctype="multipart/form-data" >

									<input type="hidden" name="_token" value="{{ csrf_token() }}">
										
										@include('admin.news_form', array('is_new'=>true) )
