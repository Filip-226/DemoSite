...
@section('content')
							...
							<div class="container-fluid">
								...
								<div data-widget-group="group1">
									...
									<form class="form-horizontal" role="form" method="POST" action="{{ URL::route('panel.admin.user_inbox_reply', array($user_id, $msg_id)) }}" id="user_create_form" name="user_create_form" >
