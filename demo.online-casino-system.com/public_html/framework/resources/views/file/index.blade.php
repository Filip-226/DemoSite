...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/css/file/cropper.min.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/css/file/lfm.css">
    ...
    <div class="row fill">
        <div class="panel panel-primary fill">
            <div class="panel-heading">
                <h3 class="panel-title">Topup System File Manager</h3>
            </div>
...
<script src="{{ URL::to('/') }}/js/file/cropper.min.js"></script>
<script src="{{ URL::to('/') }}/js/file/jquery.form.min.js"></script>
<script>
